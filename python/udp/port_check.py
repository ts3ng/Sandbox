...
class PortCheck(NetworkCheck):

    SOURCE_TYPE_NAME = 'system'
    SERVICE_CHECK_NAME = 'port.can_connect'
    ...
    def _load_conf(self, instance):
        ...
        socket_type = instance.get('type', None)
        try:
            port = int(port)
        except Exception:
        ...
        if socket_type is None or socket_type.upper() == "TCP":
            try:
    ...
    def _check(self, instance):
        ...
        try:
            ...
            if "timed out" in str(e):
                ...
                self.log.info("System port timeout. Assuming that the checked system is down")
